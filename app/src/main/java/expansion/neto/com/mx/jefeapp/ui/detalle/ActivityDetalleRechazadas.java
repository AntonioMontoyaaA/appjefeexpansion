package expansion.neto.com.mx.jefeapp.ui.detalle;
...
import expansion.neto.com.mx.jefeapp.fragment.fragmentDetalle.FragmentDetalleRechazadas;
...
public class ActivityDetalleRechazadas extends AppCompatActivity{
    ...
    public void mostrarTip(String pantalla){
        ProviderConsultaTips.getInstance(ActivityDetalleRechazadas.this).obtenerTips(pantalla, new ProviderConsultaTips.ConsultaTips() {
            @Override
            public void resolve(Tips tip) {
                if(tip.getCodigo()==200){
                    ...
                    if(tip.getTips().size()>0){
                        ...
                        Toast.makeText(ActivityDetalleRechazadas.this, "Aún no se agrega tip para esta opción",
                            Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(ActivityDetalleRechazadas.this, tip.getMensaje(),
                            Toast.LENGTH_SHORT).show();
                }
            }
