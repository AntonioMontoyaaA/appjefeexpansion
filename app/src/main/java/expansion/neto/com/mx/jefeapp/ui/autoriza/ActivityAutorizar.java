...
import static expansion.neto.com.mx.jefeapp.fragment.fragmentCreacion.modulos.guardarDatos.GuardarDatosSuperficieCrear.obtenerSuperficie;
...
public class ActivityAutorizar extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDataBinding();
        cleanShared(ActivityAutorizar.this);
        currentItem = 0;
        ...
        binding.pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if(position==1) {
                    ...
                    CrearDatosSitio crearDatosPropietario = obtenerSitio(ActivityAutorizar.this);
                    if(crearDatosPropietario!=null || !crearDatosPropietario.getNombreSitio().equals("")){
                        FragmentDatosSitio crear = new FragmentDatosSitio(ActivityAutorizar.this);
                ...
                if(position==2){
                    ...
                    if(!mdId.equals("") || mdId.equals("0")){
                        CrearDatosPropietario crearDatosPropietario = obtenerPropietario(ActivityAutorizar.this);


                        if(!crearDatosPropietario.getMdId().equals("") && crearDatosPropietario!=null){
                            FragmentDatosPropietario crear = new FragmentDatosPropietario(ActivityAutorizar.this);
                ...
                if(position==3){
                    ...
                    if(!mdId.equals("") || mdId.equals("0")){
                        CrearDatosSuperficie crearDatosSuperficie = obtenerSuperficie(ActivityAutorizar.this);
                        if(!crearDatosSuperficie.getMdId().equals("") && crearDatosSuperficie!=null){
                            crearDatosSuperficie.setMdId(mdId);
                            FragmentDatosSuperficie crear = new FragmentDatosSuperficie(ActivityAutorizar.this);
                ...
                if(position==4){
                    ...
                    if(!mdId.equals("") || mdId.equals("0")) {
                        ...
                        String json = obtenerZonificacion(ActivityAutorizar.this);
                        if (json.length() > 0 || !json.equals("")) {
                            FragmentDatosZonificacion crear = new FragmentDatosZonificacion(ActivityAutorizar.this);
                ...
                if(position==5){
                    ...
                    if(!mdId.equals("") || mdId.equals("0")){
                        String json = obtenerConstruccion(ActivityAutorizar.this);
                        if(json.length()>0 || !json.equals("")){
                            FragmentDatosConstruccion crear = new FragmentDatosConstruccion(ActivityAutorizar.this);
                ...
                if(position==6){
                    ...
                    if(!mdId.equals("") || mdId.equals("0")){
                        CrearGeneralidades generalidades = obtenerGeneralidades(ActivityAutorizar.this);
                        if(!generalidades.getMdId().equals("") && generalidades!=null){
                            FragmentDatosGeneralidades crear = new FragmentDatosGeneralidades(ActivityAutorizar.this);
    ...
    public void mostrarTip(String pantalla){
        ProviderConsultaTips.getInstance(ActivityAutorizar.this).
                obtenerTips(pantalla, new ProviderConsultaTips.ConsultaTips() {
            @Override
